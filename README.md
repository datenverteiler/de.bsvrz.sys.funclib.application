[![Build Status](https://travis-ci.org/datenverteiler/de.bsvrz.sys.funclib.application.svg?branch=develop)](https://travis-ci.org/datenverteiler/de.bsvrz.sys.funclib.application)
